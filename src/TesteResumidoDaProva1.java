...
//		
	...
	void testeCadastrarAnimal() {
		...
		Animal bovino1 = new Bovino(1, "Zeze", 21, 9, 2018, 0, 500, 250);
		Animal suino1 = new Suino(2, "Quasimodo", 10, 5, 2018, 0, 800, 300);
		Animal caprino1 = new Caprino(3, "Barnabe", 10, 10, 2018, 0, 400, 200);
		...
		assertEquals(2, sistema.listarResumoDeAnimais(1, 0, true, true));
	}
	...
	void testeListarResumoDeAnimais() {
		...
		Animal caprino1 = new Caprino(7, "Sofia", 11, 3, 2017, 1, 400, 200);	// Adulto/Femea
		...
		assertEquals(true, caprino1.isAdulto().first);		
